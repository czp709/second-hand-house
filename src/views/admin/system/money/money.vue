<template>
  <div class="Sidebar">
    <div class="searchWord">
      <el-input v-model="search" @input="searchName" style="display: inline-block;"placeholder="请输入搜索内容"></el-input>
    ...
    <el-table :data="tableData">
        ...
        <el-table-column align="center" header-align="center" label="缴纳金额" >
            <template slot-scope="{row}">
            <span>500</span>
            </template>
        </el-table-column>
...
export default {
  ...
  methods:{
    ...
    mounted () {
        ...
        var that = this;
        const query="db.collection(\"UserList\").where({'moneyflag':true}).get()";
        const querydata={
